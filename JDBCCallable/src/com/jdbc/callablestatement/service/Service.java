package com.jdbc.callablestatement.service;
...
import com.jdbc.callablestatement.model.DatabaseName;
import com.jdbc.callablestatement.model.User;
import com.jdbc.callablestatement.repository.ConnectionDemo;
...
public class Service {
	...
	public void updateUser() throws SQLException {
		...
		PreparedStatement preparedStatement = con
				.prepareStatement("update student1 set first = ?, age = ? where id = " + userId);
	...
	public void showData() throws SQLException {
		...
		CallableStatement callableStatement = con.prepareCall("{call showData()}");
	...
	public void deleteUser(int deleteById) throws SQLException {
		CallableStatement callableStatement = con.prepareCall("{call deleteById(" + deleteById + ")}");
